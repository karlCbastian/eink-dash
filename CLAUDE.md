...
- Väderbilden dithras till 1-bit med Floyd-Steinberg i `draw_weather_image()`. Testade panelens
  eget 4-gråtonsläge (`Init_4Gray`), men det renderades prickigt/halvtonigt på riktiga panelen —
  gick tillbaka till dithring. Nästan-vita pixlar klipps till rent vitt (`_WHITE_CLIP`) innan
  dithringen, annars prickas himmel/bakgrund ner i onödan.
